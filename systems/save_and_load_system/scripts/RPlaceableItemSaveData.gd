class_name RPlaceableShoppeFurnitureSaveData
extends RSaveData
...
static func pack_save_data(placeable_node: Node2D) -> RPlaceableShoppeFurnitureSaveData:
	var save_data: RPlaceableShoppeFurnitureSaveData = RPlaceableShoppeFurnitureSaveData.new()
